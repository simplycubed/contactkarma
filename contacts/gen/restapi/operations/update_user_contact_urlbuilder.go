...
func (o *UpdateUserContactURL) Build() (*url.URL, error) {
	...
	if unifiedID != "" {
		...
		return nil, errors.New("unifiedId is required on UpdateUserContactURL")
	}
...
func (o *UpdateUserContactURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateUserContactURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateUserContactURL")
	}
