...
func (o *PostContactTagURL) Build() (*url.URL, error) {
	...
	if unifiedID != "" {
		...
		return nil, errors.New("unifiedId is required on PostContactTagURL")
	}
...
func (o *PostContactTagURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostContactTagURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostContactTagURL")
	}
