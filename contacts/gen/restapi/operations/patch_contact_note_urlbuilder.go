...
func (o *PatchContactNoteURL) Build() (*url.URL, error) {
	...
	if noteID != "" {
		...
		return nil, errors.New("noteId is required on PatchContactNoteURL")
	}
	...
	if unifiedID != "" {
		...
		return nil, errors.New("unifiedId is required on PatchContactNoteURL")
	}
...
func (o *PatchContactNoteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchContactNoteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchContactNoteURL")
	}
