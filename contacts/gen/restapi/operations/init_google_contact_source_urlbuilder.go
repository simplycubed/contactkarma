...
func (o *InitGoogleContactSourceURL) Build() (*url.URL, error) {
	...
	var _path = "/contacts/sources/google/init"
...
func (o *InitGoogleContactSourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on InitGoogleContactSourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on InitGoogleContactSourceURL")
	}
