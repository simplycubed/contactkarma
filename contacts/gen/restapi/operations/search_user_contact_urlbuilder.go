...
func (o *SearchUserContactURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SearchUserContactURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SearchUserContactURL")
	}
