...
func (o *LinkGoogleContactSourceURL) Build() (*url.URL, error) {
	...
	var _path = "/contacts/sources/google/link"
...
func (o *LinkGoogleContactSourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on LinkGoogleContactSourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on LinkGoogleContactSourceURL")
	}
