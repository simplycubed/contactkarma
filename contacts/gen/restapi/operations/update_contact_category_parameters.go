...
// UpdateContactCategoryParams contains all the bound params for the update contact category operation
...
func (o *UpdateContactCategoryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateCategoryDto
...
func (o *UpdateContactCategoryParams) bindXApigatewayAPIUserinfo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateContactCategoryParams) bindUnifiedID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
