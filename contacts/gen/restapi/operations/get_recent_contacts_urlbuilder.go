...
func (o *GetRecentContactsURL) Build() (*url.URL, error) {
	...
	var lastDocumentLastContactQ string
	if o.LastDocumentLastContact != nil {
		lastDocumentLastContactQ = o.LastDocumentLastContact.String()
	}
	if lastDocumentLastContactQ != "" {
		qs.Set("last_document_last_contact", lastDocumentLastContactQ)
	}
	...
	var maxDaysQ string
	if o.MaxDays != nil {
		maxDaysQ = swag.FormatInt64(*o.MaxDays)
	}
	if maxDaysQ != "" {
		qs.Set("max_days", maxDaysQ)
	}
...
func (o *GetRecentContactsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRecentContactsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRecentContactsURL")
	}
