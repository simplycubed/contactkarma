...
// CreateUserContactParams contains all the bound params for the create user contact operation
...
func (o *CreateUserContactParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateContactDto
...
func (o *CreateUserContactParams) bindXApigatewayAPIUserinfo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
