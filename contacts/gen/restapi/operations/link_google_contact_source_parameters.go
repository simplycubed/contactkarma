...
// LinkGoogleContactSourceParams contains all the bound params for the link google contact source operation
...
func (o *LinkGoogleContactSourceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body LinkGoogleContactSourceBody
...
func (o *LinkGoogleContactSourceParams) bindXApigatewayAPIUserinfo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
