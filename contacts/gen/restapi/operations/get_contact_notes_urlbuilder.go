...
func (o *GetContactNotesURL) Build() (*url.URL, error) {
	...
	if unifiedID != "" {
		...
		return nil, errors.New("unifiedId is required on GetContactNotesURL")
	}
...
func (o *GetContactNotesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetContactNotesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetContactNotesURL")
	}
