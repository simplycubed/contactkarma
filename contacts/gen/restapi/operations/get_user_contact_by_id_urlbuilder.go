...
func (o *GetUserContactByIDURL) Build() (*url.URL, error) {
	...
	var _path = "/unified/{unified_id}"

	unifiedID := o.UnifiedID
	if unifiedID != "" {
		_path = strings.Replace(_path, "{unified_id}", unifiedID, -1)
	} else {
		return nil, errors.New("unifiedId is required on GetUserContactByIDURL")
	}
...
func (o *GetUserContactByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetUserContactByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetUserContactByIDURL")
	}
