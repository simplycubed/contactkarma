...
func (o *PatchContactTagURL) Build() (*url.URL, error) {
	...
	if tagID != "" {
		...
		return nil, errors.New("tagId is required on PatchContactTagURL")
	}
	...
	if unifiedID != "" {
		...
		return nil, errors.New("unifiedId is required on PatchContactTagURL")
	}
...
func (o *PatchContactTagURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchContactTagURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchContactTagURL")
	}
