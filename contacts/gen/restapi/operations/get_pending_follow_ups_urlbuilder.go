...
func (o *GetPendingFollowUpsURL) Build() (*url.URL, error) {
	...
	var lastDocumentNextContactQ string
	if o.LastDocumentNextContact != nil {
		lastDocumentNextContactQ = o.LastDocumentNextContact.String()
	}
	if lastDocumentNextContactQ != "" {
		qs.Set("last_document_next_contact", lastDocumentNextContactQ)
	}
...
func (o *GetPendingFollowUpsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPendingFollowUpsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPendingFollowUpsURL")
	}
