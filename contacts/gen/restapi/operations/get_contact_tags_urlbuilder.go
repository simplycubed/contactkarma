...
func (o *GetContactTagsURL) Build() (*url.URL, error) {
	...
	var _path = "/unified/{unified_id}/tags"

	unifiedID := o.UnifiedID
	if unifiedID != "" {
		_path = strings.Replace(_path, "{unified_id}", unifiedID, -1)
	} else {
		return nil, errors.New("unifiedId is required on GetContactTagsURL")
	}
...
func (o *GetContactTagsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetContactTagsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetContactTagsURL")
	}
