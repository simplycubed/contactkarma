...
func (o *ContactSourceCleanUpURL) WithBasePath(bp string) *ContactSourceCleanUpURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ContactSourceCleanUpURL) Build() (*url.URL, error) {
	...
	var _path = "/contact-source-clean-up"
...
func (o *ContactSourceCleanUpURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ContactSourceCleanUpURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ContactSourceCleanUpURL")
	}
