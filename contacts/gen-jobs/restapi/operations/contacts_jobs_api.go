...
func NewContactsJobsAPI(spec *loads.Document) *ContactsJobsAPI {
	return &ContactsJobsAPI{
		...
		ContactSourceCleanUpHandler: ContactSourceCleanUpHandlerFunc(func(params ContactSourceCleanUpParams) middleware.Responder {
			return middleware.NotImplemented("operation ContactSourceCleanUp has not yet been implemented")
		}),
		PullContactSourceHandler: PullContactSourceHandlerFunc(func(params PullContactSourceParams) middleware.Responder {
			return middleware.NotImplemented("operation PullContactSource has not yet been implemented")
		}),
		PullContactsHandler: PullContactsHandlerFunc(func(params PullContactsParams) middleware.Responder {
			return middleware.NotImplemented("operation PullContacts has not yet been implemented")
		}),
	}
}
...
func (o *ContactsJobsAPI) Validate() error {
	...
	if o.ContactSourceCleanUpHandler == nil {
		unregistered = append(unregistered, "ContactSourceCleanUpHandler")
	}
	if o.PullContactSourceHandler == nil {
		unregistered = append(unregistered, "PullContactSourceHandler")
	}
	if o.PullContactsHandler == nil {
		unregistered = append(unregistered, "PullContactsHandler")
	}
...
func (o *ContactsJobsAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/contact-source-clean-up"] = NewContactSourceCleanUp(o.context, o.ContactSourceCleanUpHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/pull-contact-source"] = NewPullContactSource(o.context, o.PullContactSourceHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/pull-contacts"] = NewPullContacts(o.context, o.PullContactsHandler)
}
