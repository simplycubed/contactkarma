...
func (o *PullContactSourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PullContactSourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PullContactSourceURL")
	}
