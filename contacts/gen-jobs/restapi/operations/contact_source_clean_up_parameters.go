...
// ContactSourceCleanUpParams contains all the bound params for the contact source clean up operation
...
func (o *ContactSourceCleanUpParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
